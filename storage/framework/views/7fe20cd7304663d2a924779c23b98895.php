    ...
    <div class="container-sm my-5">
        <div class="row justify-content-center">
            <div class="p-5 bg-light rounded-3 col-xl-4 border">
                ...
                <hr>
                <div class="row">
                    <div class="col-md-12 mb-3"> <label for="firstName" class="form-label">First Name</label>
                        <h5><?php echo e($employee->firstname); ?></h5>
                    </div>
                    <div class="col-md-12 mb-3"> <label for="lastName" class="form-label">Last Name</label>
                    ...
                    <div class="col-md-12 mb-3"> <label for="age" class="form-label">Age</label>
                ...
                <hr>
                <div class="row">
                    <div class="col-md-12 d-grid"> <a href="<?php echo e(route('employees.index')); ?>"
...
<?php /**PATH C:\Users\firma\database_laravel\resources\views/employee/show.blade.php ENDPATH**/ ?>